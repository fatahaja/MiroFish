                ...
                <div class="range-wrapper">
                  ...
                  <div class="range-marks">
                    ...
                    <span 
                      ...
                      :class="{ active: customMaxRounds === 30 }"
                      @click="customMaxRounds = 30"
                      :style="{ position: 'absolute', left: `calc(${(30 - 10) / (autoGeneratedRounds - 10) * 100}% - 30px)` }"
                    >{{ $t('step2.recommendedRounds', { rounds: 30 }) }}</span>
...
const customMaxRounds = ref(30)   // 默认推荐30轮
...
const autoGeneratedRounds = computed(() => {
  ...
  // 确保最大轮数不小于30（推荐值），避免滑动条范围异常
  return Math.max(calculatedRounds, 30)
})
